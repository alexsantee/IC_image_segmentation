...
subset = shuffle(img_2d, n_samples=1000)
kmeans = KMeans(n_clusters=128).fit(subset)
...
# print("k-mean start")
# centroids, pixels = k_means(attr, N_CLUSTERS, 2, X, Y, 1337)
# print("k-mean end")
# clustered_img = rgb_image_from(centroids, pixels, N_CLUSTERS, img.shape)
# print("centroids:")
# print(centroids)
# plt.imshow(clustered_img)
# plt.show()
